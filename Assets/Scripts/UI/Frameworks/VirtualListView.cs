...
namespace Demo
{
    ...
    public class VirtualListView : MonoBehaviour
    {
        ...
        /// 单元格尺寸（宽，高）
        /// </summary>
        [UnityEngine.Header("单元格尺寸(宽，高)")]
        public Vector2 CellSize;
        /// <summary>
        /// 单元格间隙（水平，垂直）
        /// </summary>
        [UnityEngine.Header("单元格间隙(水平，垂直)")]
        public Vector2 SpacingSize;
        /// <summary>
        /// 列数
        /// </summary>
        [UnityEngine.Header("列数")]
        public int ColumnCount;
        /// <summary>
        /// 单元格渲染器prefab
        /// </summary>
        [UnityEngine.Header("渲染的prefab子item")]
        ...
        /// 渲染脚本集合
        /// </summary>
        protected List<VirtualListItem> mList_items;
        /// <summary>
        /// 渲染格子字典
        /// </summary>
        ...
        {
            float y = Mathf.CeilToInt((count * 1.0f / ColumnCount)) * GetBlockSizeY();
            if (y < 550)
                y = 550;
            else
                y -= SpacingSize.y;
            mRectTransformContainer.sizeDelta = new Vector2(mRectTransformContainer.sizeDelta.x, y);
        ...
        void _UpdateChildTransformPos(GameObject child, int index)
        {
            ...
            {
                x = column * GetBlockSizeX(),
                y = -CellSize.y - row * GetBlockSizeY()
            };
